...
class OrderAdmin(admin.ModelAdmin):
    list_display = ['user', 'ordered','beign_delivered','received','refund_requested','refund_granted','billing_address', 'shipping_address','payment','coupon']

    list_filter = ['ordered','beign_delivered','received','refund_requested','refund_granted']
